...
<div class="space-y-6">
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <x-stat-card label="Upwork Accounts" :value="$stats['total_upwork_accounts']" icon="fa-id-card" />
        <x-stat-card label="Sales Managers" :value="$stats['total_sales_managers']" icon="fa-user-tie" />
        <x-stat-card label="Project Managers" :value="$stats['total_project_managers']" icon="fa-users" />
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <x-stat-card label="Won" :value="$stats['won_bids']" icon="fa-trophy" />
        <x-stat-card label="Lost" :value="$stats['lost_bids']" icon="fa-circle-xmark" />
    </div>
